...
Le terme *tidyverse* est une contraction de *tidy* (qu'on pourrait traduire par "bien rangé") et de *universe*. En allant visiter le site internet de ces extensions [tidyverse](https://www.tidyverse.org/), voici ce que nous pouvons trouver sur la première page du site:
...
Nous n'utiliserons pas toutes les possibilités de ces extensions. 
...
On verra plus précisément dans la section comment définir et rendre des données *tidy* avec l'extension `tidyr`.
