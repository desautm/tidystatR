...
```{r addin-irec, echo = FALSE, out.width = "25%", fig.cap = "_Levels recoding_ dans le menu _Addins_"}
...
```{r irec, echo = FALSE, out.width = "100%", fig.cap = "L'interface graphique de _Levels recoding_"}
